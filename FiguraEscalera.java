 ...
 * @author pablo
 */
public class FiguraEscalera extends CuatroFiguras {
    boolean girar=true;
    
    
    public FiguraEscalera(Figura uno, Figura Dos, Figura Tres, Figura Cuatro, JButton[][] a, int [][] b) {
    ...
    public void movimientoIzquierda() {
        if(girar){
            if(uno.x==0||super.Matriz[uno.x-1][uno.y]!=0&&super.Matriz[Tres.x-1][Tres.y]!=0){
            ...
            if(Tres.x==0||super.Matriz[Tres.x-1][Tres.y]!=0&&Cuatro.x==0||super.Matriz[Cuatro.x-1][Cuatro.y]!=0&&super.Matriz[uno.x-1][uno.y]!=0&&Tres.x==0){
    ...
    public void movimientoDerecha() {
        if(girar){
            if(Cuatro.x==9||super.Matriz[Cuatro.x+1][Cuatro.y]!=0&&super.Matriz[Dos.x+1][Dos.y]!=0){
            ...
            if(uno.x==9||super.Matriz[uno.x+1][uno.y]!=0&&Dos.x==9||super.Matriz[Dos.x+1][Dos.y]!=0&&super.Matriz[Cuatro.x+1][Cuatro.y]!=0){
    ...
    public void Girar() {
        try{
        if(girar){
            if(Matriz[uno.x][uno.y+1]==0&&Matriz[uno.x-1][uno.y+1]==0&&Matriz[uno.x-1][uno.y+2]==0){
                super.BtnMatriz[uno.x][uno.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
                super.BtnMatriz[Dos.x][Dos.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
                super.BtnMatriz[Tres.x][Tres.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
                super.BtnMatriz[Cuatro.x][Cuatro.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
             ...
             if(Matriz[uno.x+1][uno.y]==0&&Matriz[uno.x+1][uno.y+1]==0&&Matriz[uno.x+2][uno.y+1]==0){
                super.BtnMatriz[uno.x][uno.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
                super.BtnMatriz[Dos.x][Dos.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
                super.BtnMatriz[Tres.x][Tres.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
                super.BtnMatriz[Cuatro.x][Cuatro.y].setIcon(new ImageIcon("C:\\Users\\pablo\\OneDrive\\Documentos\\NetBeansProjects\\ControlPacman\\Img\\"+"Black"+".png"));
